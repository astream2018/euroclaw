...
class AgentDAGTracer:
    ...
    def export_to_markdown(self, output_dir: str = "audit_logs"):
        ...
        mermaid_code.append("    classDef secure fill:#e1f5fe,stroke:#0288d1,stroke-width:2px;")
        mermaid_code.append("    classDef danger fill:#ffebee,stroke:#d32f2f,stroke-width:2px;")
