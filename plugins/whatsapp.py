...
class WhatsAppPlugin(MessagingPlugin):
    ...
    def receive_message(self, raw_webhook_data: dict) -> dict:
        try:
            ...
            return {"source": "whatsapp", "user_id": message["from"], "text": message["text"]["body"]}
        except (KeyError, IndexError): return None

    def send_message(self, user_id: str, text: str):
        requests.post(self.api_url, headers=self.headers, json={
            "messaging_product": "whatsapp", "to": user_id, "text": {"body": text}
        })